...
import com.acme.f4h9.model.TodoModel;
...
/**
 * The base model implementation for the Todo service. Represents a row in the &quot;F4H9_Todo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TodoModelImpl extends BaseModelImpl<Todo> implements TodoModel {
	 ...
	 */
	public static final String TABLE_NAME = "F4H9_Todo";
	...
	public static final String TABLE_SQL_CREATE =
		"create table F4H9_Todo (todoId LONG not null primary key,name VARCHAR(75) null,description VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table F4H9_Todo";

	public static final String ORDER_BY_JPQL = " ORDER BY todo.todoId ASC";

	public static final String ORDER_BY_SQL = " ORDER BY F4H9_Todo.todoId ASC";
