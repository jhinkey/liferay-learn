...
public class TodoLocalServiceWrapper
	 ...
	 */
	@Override
	public com.acme.f4h9.model.Todo addTodo(com.acme.f4h9.model.Todo todo) {
	 ...
	 */
	@Override
	public com.acme.f4h9.model.Todo createTodo(long todoId) {
	 ...
	 */
	@Override
	public com.acme.f4h9.model.Todo deleteTodo(long todoId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.acme.f4h9.model.Todo deleteTodo(com.acme.f4h9.model.Todo todo) {
	...
	@Override
	public com.acme.f4h9.model.Todo fetchTodo(long todoId) {
	 ...
	 */
	@Override
	public com.acme.f4h9.model.Todo getTodo(long todoId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.acme.f4h9.model.Todo> getTodos(
		int start, int end) {
	 ...
	 */
	@Override
	public com.acme.f4h9.model.Todo updateTodo(com.acme.f4h9.model.Todo todo) {
