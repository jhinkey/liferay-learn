...
package com.acme.f4h9.service.persistence.impl.constants;
...
public class F4H9PersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "com.acme.f4h9.service";
