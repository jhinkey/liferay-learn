...
package com.acme.f4h9.service.persistence.impl;

import com.acme.f4h9.exception.NoSuchTodoException;
import com.acme.f4h9.model.Todo;
import com.acme.f4h9.model.TodoTable;
import com.acme.f4h9.model.impl.TodoImpl;
import com.acme.f4h9.model.impl.TodoModelImpl;
import com.acme.f4h9.service.persistence.TodoPersistence;
import com.acme.f4h9.service.persistence.impl.constants.F4H9PersistenceConstants;
...
public class TodoPersistenceImpl
	...
	@Override
	@Reference(
		target = F4H9PersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = F4H9PersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
