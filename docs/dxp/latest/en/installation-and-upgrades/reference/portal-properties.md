...
```{important}
If you override a property in more than one source (a properties file or environment variable), the last property definition read takes effect. All other definitions for the property are ignored.
```
