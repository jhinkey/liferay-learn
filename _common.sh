...
readonly LIFERAY_LEARN_DEVELOPMENT_PORTAL_WORKSPACE_TOKEN=portal-7.4-ga2
...
readonly LIFERAY_LEARN_PORTAL_API_TOKEN=release.dxp.api
readonly LIFERAY_LEARN_PORTAL_DOCKER_IMAGE_TOKEN=\\[\$LIFERAY_LEARN_PORTAL_DOCKER_IMAGE\$\\]
readonly LIFERAY_LEARN_PORTAL_DOCKER_IMAGE_VALUE="${LIFERAY_LEARN_DXP_DOCKER_IMAGE_VALUE}"
readonly LIFERAY_LEARN_PORTAL_WORKSPACE_TOKEN="${LIFERAY_LEARN_DXP_WORKSPACE_TOKEN}"
