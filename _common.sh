...
readonly LIFERAY_LEARN_GENERAL_DXP_DOCKER_IMAGE_TOKEN=\\[\$LIFERAY_LEARN_GENERAL_DXP_DOCKER_IMAGE\$\\]
...
readonly LIFERAY_LEARN_GENERAL_DXP_DOCKER_IMAGE_VALUE="${LIFERAY_LEARN_PORTAL_DOCKER_IMAGE_VALUE}"
readonly LIFERAY_LEARN_GENERAL_DXP_WORKSPACE_TOKEN="${LIFERAY_LEARN_PORTAL_WORKSPACE_TOKEN}"
